...
public class ModelB {
    ...
    @ManyToOne
    @JoinColumn(name="IDModelA", foreignKey =  @ForeignKey(name =  "fkModelAToModelB", foreignKeyDefinition = "FOREIGN KEY ([IDModelA]) REFERENCES [ModelA] ([IDModelA]) ON DELETE SET NULL ON UPDATE SET NULL"))
    ...
    public com.juaracoding.atsspringbootrestapi.model.ModelA getModelA() {
        return ModelA;
    }

    public void setModelA(com.juaracoding.atsspringbootrestapi.model.ModelA modelA) {
        ModelA = modelA;
    }
}